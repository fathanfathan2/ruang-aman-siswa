    ...
    <div class="py-12 bg-slate-900 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <a href="{{ route('sesi-konseling.index') }}" class="group p-5 bg-slate-800 border border-slate-700 rounded-2xl hover:border-cyan-500 hover:shadow-lg hover:shadow-cyan-500/10 transition-all text-left">
