        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-orange-500 to-red-600 rounded-t-2xl shadow-lg p-6 sm:p-8 relative overflow-hidden">
                <div class="relative z-10">
                    ...
                    <h3 class="text-2xl font-bold text-white tracking-wide">Tambah Jenis Pelanggaran</h3>
                    <p class="text-red-100 text-sm mt-1">Isi form di bawah untuk menambahkan data pelanggaran baru.</p>
                </div>
                ...
                <form action="{{ route('jenis-pelanggaran.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_pelanggaran" name="nama_pelanggaran" value="{{ old('nama_pelanggaran') }}"
                               ...
                               class="block w-full rounded-xl border-slate-600 bg-slate-900/60 text-white placeholder-slate-500 shadow-sm focus:border-orange-500 focus:ring-orange-500 text-sm">
